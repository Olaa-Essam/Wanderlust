...
export default class HolidaysView {
    ...
    // header elements
    holidaysSelection;
    holidaysSelectionCountryFlag;
    holidaysSelectionCountryName;
    holidaysSelectionYear;
    // content elements
    holidaysContent;
    holidaysEmptyState;
    // data
    ...
    findElements() {
        ...
        this.holidaysSelectionCountryFlag = document.getElementById("holidays-selection-country-flag");
    ...
    async loadContent(year, countryCode) {
        try {
...
//# sourceMappingURL=holidaysView.js.map