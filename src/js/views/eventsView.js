...
export default class EventsView {
    ...
    // header elements
    eventsSelection;
    eventsSelectionCountryFlag;
    eventsSelectionCountryName;
    eventsSelectionCity;
    // content elements
    eventsContent;
    eventsEmptyState;
    eventsNotFoundEmptyState;
    // data
    events = [];
    ...
    findElements() {
        ...
        this.eventsSelectionCountryFlag = document.getElementById("events-selection-country-flag");
    ...
    async loadContent(countryCode, stateCode) {
        try {
    ...
    formatDateTime(localDate, localTime) {
